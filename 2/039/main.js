...
const Pin = () => {
  ...
  React.useEffect(() => {
    if (pin.length === 6) {
      // ini untuk menentukan maksimal password yang bisa diinputkan tanpa terpengauh jumlah kotak
      const verify = async () => {
        try {
  ...
  const handleOnChange = (e) => {
    if (e.target.value.length <= 6) {
      // ini diubah sesuai banyak inputan password
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(PinDigit, {
        // ini gunanya untuk memunculkan kotak kolom pengisian password
        focused: pin.length === 4,
        value: pin[4],
      }),
      React.createElement(PinDigit, {
        // ini gunanya untuk memunculkan kotak kolom pengisian password
        focused: pin.length === 5,
        value: pin[5],
      })
    ),
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          {
            ...
            href: "04/index.html",
            target: "", //kalau mau kebuka di tab baru, kasi kode  _blank
          },
          React.createElement("i", { className: "fa-brands fa-google" }),
          React.createElement("span", null, "Disiniii !!")
        )
      )
    )
  );
